...
public class MainController {
    ...
    public String searchFlight(@RequestParam("departureAirport") int departureAirport,
        ...
        depAirport.setAirportName("Indira Gandhi International Airport");
        System.out.println("Fetching departure airport second time:");
        Airport depAirport2 = airportService.getAirportById(departureAirport);

        System.out.println("This is after second fetch");
        System.out.println("Airport name:"+depAirport.getAirportName());
        if (departureAirport == destinationAirport) {
